...
thridText = "Backend Developer"
fourthText = "Freelance";
fifthText = "Ionic Developer";
sixthText = "Mobile Application Developer"
seventhText = "Angular developer";
eigthText = "Node Js Developer";
intervalTime = 1000;
...
function displayText() {
    ...
    setTimeout(() => {
        document.querySelector('.designer').innerText = sixthText;
    }, intervalTime * 6);
    setTimeout(() => {
        document.querySelector('.designer').innerText = seventhText;
    }, intervalTime * 7);
    setTimeout(() => {
        document.querySelector('.designer').innerText = eigthText;
    }, intervalTime * 8);
...
function displayText2() {
    ...
    setTimeout(() => {
        document.querySelector('.designer2').innerText = eigthText;
    }, intervalTime * 8);
}
setInterval(() => {
    displayText();
